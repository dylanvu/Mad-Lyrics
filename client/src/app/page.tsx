    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
            <div className="main-div">
                ...
                <br />
                I put on my <input type="text" />, feeling so{" "}
                <input type="text" />,
                <br />
                ...
                <br />
                Together we're <input type="text" />, oh so{" "}
                <input type="text" />.
                <br />
                <br />
                Bridge:
                ...
                <br />
                <input type="text" /> and <input type="text" /> in our{" "}
                <input type="text" /> dream,
                <br />
                ...
                Outro:
                <br />
                So here's to the <input type="text" />, the{" "}
                <input type="text" />, and <input type="text" />,
                <br />
                With you, my heart feels <input type="text" />.
                <br />
                Let's sing this song from <input type="text" /> to{" "}
                <input type="text" />,
                <br />
